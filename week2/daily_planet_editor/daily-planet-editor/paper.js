...
{
    return "Superman beats " +enemies.name+ ", of course";
}

else{
    return "Depends on how quick Superman can get rid of the Kryptonite. "+ enemies.name +" could possibly win this one.";
}
    }
